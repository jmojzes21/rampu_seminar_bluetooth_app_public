...
import '../device/my_bt_device.dart';
import '../device/my_device.dart';
import 'device_page.dart';

class BtDeviceDiscoveryPage extends StatefulWidget {
  const BtDeviceDiscoveryPage({super.key});

  @override
  State<BtDeviceDiscoveryPage> createState() => _BtDeviceDiscoveryPageState();
}

class _BtDeviceDiscoveryPageState extends State<BtDeviceDiscoveryPage> {
  ...
  Future<void> startDiscovery() async {
    ...
    if (bluetoothState.isEnabled == false) {
      showAlertDialog(
        title: 'Bluetooth',
    ...
    discoverySubscription =
        discoveryStream.listen((BluetoothDiscoveryResult discoveredDevice) {
      setState(() {
        devices.add(discoveredDevice.device);
      });
    });
  }
  ...
  Future<void> openDevice(BluetoothDevice device) async {
    ...
    try {
      var myDevice = MyBtDevice(device);
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var deviceName = device.name ?? 'Nepoznati uređaj';
